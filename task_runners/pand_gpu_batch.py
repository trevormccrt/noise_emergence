...
evolution_runners.evolve_random_batch(N, max_k, population_size, keep_best, n_populations, n_trajectories, noise_prob,
                                      ...
                                      tasks.make_4_bit_input_state, tasks.evaluate_pnand_task, f_breed, f_mutate,
                                      out_dir, file_name, True,
                                      checkpointing_dir=checkpointint_dir, checkpointing_freq=1000)
